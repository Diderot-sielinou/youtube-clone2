...
export function Scroll() {
    ...
    return (
        <div ref={containerRef} className="overflow-x-hidden relative h-7 overflow-hidden bg-black ">
            <div className="flex items-center whitespace-nowrap gap-3 transition-transform w-[max-content]" style={{ transform: `translateX(-${translate}px)` }}>
